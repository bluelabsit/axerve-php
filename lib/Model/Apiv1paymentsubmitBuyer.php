...
/**
 * Apiv1paymentsubmitBuyer Class Doc Comment
 *
 * @category Class
 * @package  Axerve\Client
 * @author   Axerve Codegen team
 * @link     https://github.com/axerve-api/axerve-codegen
 */
class Apiv1paymentsubmitBuyer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $axerveModelName = 'apiv1paymentsubmit_buyer';
...
'email' => 'getEmail'    ];
    ...
    {
        return $this->container['name'] ?? $tho;
    }
