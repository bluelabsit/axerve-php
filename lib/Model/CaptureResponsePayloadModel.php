...
/**
 * CaptureResponsePayloadModel Class Doc Comment
 *
 * @category Class
 * @package  Axerve\Client
 * @author   Axerve Codegen team
 * @link     https://github.com/axerve-api/axerve-codegen
 */
class CaptureResponsePayloadModel implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $axerveModelName = 'inline_response_200_7_payload';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transaction_result'] === null) {
            $invalidProperties[] = "'transaction_result' can't be null";
        }
        if ($this->container['bank_transaction_id'] === null) {
            $invalidProperties[] = "'bank_transaction_id' can't be null";
        }
        if ($this->container['shop_transaction_id'] === null) {
            $invalidProperties[] = "'shop_transaction_id' can't be null";
        }
